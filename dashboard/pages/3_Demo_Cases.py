...
def load_cases():
    try:
        ...
        return [
            {"id": "R1", "text": "НБУ підвищив облікову ставку.", "expected_label": "REAL"},
            {"id": "F1", "text": "ТЕРМІНОВО!!! ЗСУ ЗДАЛИ Харків!", "expected_label": "FAKE"},
            {"id": "S1", "text": "Можливо, скоро запровадять нові штрафи.", "expected_label": "SUSPICIOUS"},
        ]
